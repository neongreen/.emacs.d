...
(custom-set-faces
 ...
 '(font-lock-comment-delimiter-face ((t (:foreground "#7f7fcc" :family ".SF NS Text" :height 1.0 :weight light :slant italic))))
 '(font-lock-comment-face ((t (:foreground "#7f7fcc" :family ".SF NS Text" :height 0.95 :weight light :slant italic))))
 '(font-lock-doc-face ((t (:foreground "#da5897" :family ".SF NS Text" :height 0.95 :weight light :slant italic))))
